...
This is a list of software (SaaS, PaaS, IaaS, BaaS, etc.) and other offerings that have free tiers for developers.
...
- [Tamber](https://tamber.com) — Put deepL powered recommendations in your app. Free 5k monthly active users.
...
## Management Sysytem {#management-system}
...
- [here.com](https://developer.here.com/) — APIs and SDKs for maps and location-aware apps. 250k transactions/month for free.
...
- [Visualime.com](https://www.visualime.com/) — Free and unlimited session recording, no traffic limits
